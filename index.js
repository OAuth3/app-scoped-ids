...
module.exports.scope = module.exports.cipher = function (val, secret) {
...
module.exports.unscope = module.exports.decipher = function (crypted, secret) {
  var secbuf =  crypto.createHash('sha1').update(secret).digest().slice(0, 16);
